...
ActiveRecord::Schema.define(version: 2022_02_20_230704) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "carrito_products", force: :cascade do |t|
    t.bigint "carrito_id", null: false
    t.bigint "product_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["carrito_id"], name: "index_carrito_products_on_carrito_id"
    t.index ["product_id"], name: "index_carrito_products_on_product_id"
  end
  ...
  add_foreign_key "carrito_products", "carritos"
  add_foreign_key "carrito_products", "products"
